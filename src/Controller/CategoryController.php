...
class CategoryController extends AbstractController
{
    ...
    /**
     * @Route("/{id}/item", name="category_filter", methods={"GET"})
     */
    public function categoryItem( CategoryRepository $categoryRepository, PaginatorInterface $paginator,Request $request, $id): Response
    {
        $search = $request->get('search');
        
        $autos = $categoryRepository->getAutosByCategory($id, $search);
